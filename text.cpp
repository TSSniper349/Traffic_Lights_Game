...
// create a text object with a specified font, font size, message text and color
...
// create a text object for the instruction text with a specified font, font size, message text and color
...
// load a font and return a texture of the text
...
// load a font used for the instruction text
