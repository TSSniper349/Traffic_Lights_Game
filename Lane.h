...
// represent the lanes, devive from the Coordination Class
class Lane: public Coordination {
    private:
        float max_length;// maximum length of the lane
        float curr_length;// current length of the lane
        std::vector<Vehicle> *list_vehicles;// list of vehicles
    public:
    Lane();
